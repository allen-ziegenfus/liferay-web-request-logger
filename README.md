...
The latest release is available from [SourceForge - Liferay Request Logger](https://sourceforge.net/projects/permeance-apps/files/liferay-request-logger/ "Liferay Request Logger").
